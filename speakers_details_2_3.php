		<div class="row">
			<div class="col-12">
				...
				<div style="align=left;">
					<h5>Track 3:<span class="alternate"> Life Sciences</span></h5>
					<p></p>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="images/speakers/t3sp1.jpg" alt="speaker" class="img-fluid">

					</div>
					<div class="content text-center">
						<h5><a href="t3sp1.php">Dr. SAJI GEORGE</a></h5>
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				...
				<div class="speaker-item">
					<div class="image">
						<img src="images/speakers/t3sp2.jpg" alt="speaker" class="img-fluid">
					</div>
					<div class="content text-center">
